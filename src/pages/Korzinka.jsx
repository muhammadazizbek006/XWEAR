          ...
          <div className="containerb ">
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start   ">
                ...
                <ul className="bg-white shadow drop-shadow-md rounded-2xl py-3 px-2 sm:px-8 w-full  md:w-4/6 md:mr-12  mb-8 sm:mb-0">
                  {tanlanganMahsulotlar.map((e) => {
                    return (
                      <li className="flex justify-between items-center border-b-2  relative">
                        ...
                        <div className="flex flex-col lg:flex-row  items-center">
                          ...
                          <div>
                            ...
                            <span className=" text-sm lg:text-base font-medium sm:font-semibold">{e.brend}</span>
                          </div>
                        </div>
                        ...
                        {/* summa */}
                        <div>
                          <p className="text-base"> <span className=" text-sm sm:text-base font-medium sm:font-semibold">категория:</span> {e.kategoria}</p>
                          <p className="text-base "> <span className=" text-sm sm:text-base font-medium sm:font-semibold">расходы: </span>{e.narxi}  ₽</p>
                        </div>
                        {/* delete btn  */}
              ...
              <div className="bg-white shadow-md py-8 px-6 h-48 rounded-md flex flex-col items-center">
                ...
                <Link to='/sotibolish' className="px-8 py-3 bg-black rounded-md text-white hover:bg-green-500 duration-500">скручивание</Link>
              </div>
